...
## <a name="1.1.5"></a> 1.1.5 (2019-01-30)

PipPicture could accept defaultIcon from custom fontSet now
...
## <a name="1.1.6"></a> 1.1.6 (2019-06-14)
...
## <a name="1.1.12"></a> 1.1.12 (2019-12-20)
...
## <a name="1.1.13"></a> 1.1.13 (2022-09-20)

Add options to disable some sources for the add image
